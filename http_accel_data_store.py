...
# esp32보드에 장착된 mp9250 으로부터 1초당 128개의 3축 가속도 센서값을 json 파일
# 형태로 받아들이고 이를 현재폴더에 있는 real_data/normal 및 abnormal 폴더에 저장하는 프로그램
import os
import argparse
import json
import threading
...
################################################################################
# Main
# 터미널 창에서의 명령: python http_accel_server.py -d ./real_data/normal -t 0(무한반복)
# Parse arguments
